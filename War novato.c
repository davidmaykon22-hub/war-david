// ============================================================================
//               PROJETO WAR MODULARIZADO - COMPLETO
// ============================================================================
//
// OBJETIVOS ATINGIDOS:
// - Modularização do código em funções especializadas.
// - Sistema de missões sorteado para o jogador.
// - Verificação de vitória.
// - Uso de ponteiros e const correctness.
// - Simulação de ataque estilo WAR (dados).
//
// ============================================================================
